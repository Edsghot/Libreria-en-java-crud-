...
public class MenuLibreria {
        ...
        do {
            ...
            switch (op) {
                ...
                case "2":
                    ...
                    break;
                case "3":
                    if (libreria.rentarDocumento(Integer.valueOf(JOptionPane.showInputDialog("Codigo del documento a rentar:")))) {
                        JOptionPane.showMessageDialog(null, "El documento ha sido rentado!!");
                    }
                    break;
                case "4":
                ...
                case "5":
                    ...
                    break;
                case "6":
                    libreria.suscribirse(Integer.valueOf(JOptionPane.showInputDialog("DNI de la persona a suscribir: ")));
                    break;
                case "7":
                	co.listar();
                   // libreria.listar();
    ...
    private Documento crearDocumento() {
        ...
        int anoPub = Integer.valueOf(JOptionPane.showInputDialog("Año publicacion: "));
    ...
    private Persona crearPersona() {
        ...
        int dni = Integer.valueOf(JOptionPane.showInputDialog("Ingrese dni: "));
        String nombre = JOptionPane.showInputDialog("Ingrese nombre: ");
        String direccion = JOptionPane.showInputDialog("Ingrese direccion: ");
        int edad = Integer.valueOf(JOptionPane.showInputDialog("Ingrese edad: "));
        switch (JOptionPane.showInputDialog("Ingrese tipo: [Alumno, Profesor]").toLowerCase()) {
            case "alumno":
                ...
                co.registrarPersona(direccion, nombre, direccion, edad, "alumno");
                break;
            case "profesor":
                persona = new Profesor(dni, nombre, direccion, edad, JOptionPane.showInputDialog("Ingrese nombre de su escuela: "));
                co.registrarPersona(direccion, nombre, direccion, edad,"profesor");
                break;
            default:
                persona = null;
        }
